...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='hold',
            name='status',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='mainapp.HoldStatus'),
        ),
        migrations.AddField(
            model_name='hold',
            name='user',
        ...
        migrations.AddField(
            model_name='book',
            name='comments',
            field=models.ManyToManyField(through='mainapp.Comment', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='book',
            name='language',
